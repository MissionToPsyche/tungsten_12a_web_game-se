...
public class GameStateManager : MonoBehaviour
{
    ...
    public string MatchScene(Scene scene)
    {
        return scene switch
        {
            ...
            Scene.Tool_Intro_GRNS           => "Tool_Intro_GRNS",
            Scene.Tool_Intro_Imager         => "Tool_Intro_Imager",
            Scene.Tool_Intro_Thruster       => "Tool_Intro_Thruster",
            Scene.Tool_Combo_1              => "Tool_Combo_1",
            Scene.Tool_Combo_2              => "Tool_Combo_2",
            Scene.Tool_Combo_3              => "Tool_Combo_3",
    ...
    public Scene MatchScene(string scene)
    {
        return scene.ToLower() switch
        {
            ...
            "tool_intro_grns"           or "grns"     => Scene.Tool_Intro_GRNS,
            "tool_intro_imager"         or "imager"   => Scene.Tool_Intro_Imager,
            "tool_intro_thruster"       or "thruster" => Scene.Tool_Intro_Thruster,
            "tool_combo_1"              or "combo1"   => Scene.Tool_Combo_1,
            "tool_combo_2"              or "combo2"   => Scene.Tool_Combo_2,
            "tool_combo_3"              or "combo3"   => Scene.Tool_Combo_3,
