...
public class GammaView : MonoBehaviour {
    ...
    void OnSceneLoaded(Scene scene, LoadSceneMode mode) {
        ...
        if (GameStateManagerSn != GameStateManager.Scene.Outro) {
            ...
            if (GameStateManagerSn == GameStateManager.Scene.Landing || GameStateManagerSn == GameStateManager.Scene.eMagnet || GameStateManagerSn == GameStateManager.Scene.Combo1 || GameStateManagerSn == GameStateManager.Scene.Combo3) {
